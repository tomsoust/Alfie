...
function App() {
  const [messages, setMessages] = useState([
    {
      message: "Hey, I'm Alfie! What is your relationship like with the gift recipient? ",
      sentTime: "just now",
      sender: "ChatGPT"
    }
  ]);
  ...
  return (
    <div className="App">
      <div style={{ position:"relative", height: "90vh", width: "90vh"  }}>
        <MainContainer>
          <ChatContainer>       
            <MessageList 
              scrollBehavior="smooth" 
              typingIndicator={isTyping ? <TypingIndicator content="Alfie is typing" /> : null}
            >
